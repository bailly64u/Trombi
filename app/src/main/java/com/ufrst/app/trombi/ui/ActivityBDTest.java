...
public class ActivityBDTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mTrombiViewModel.getAllGroupes().observe(this, groupes -> {
            StringBuilder sb = new StringBuilder();
        ...
        mTrombiViewModel.getAllEleves().observe(this, eleves -> {
            StringBuilder sb = new StringBuilder();
        ...
        mTrombiViewModel.getGroupesByTrombi(3).observe(this, groupes -> {
            StringBuilder sb = new StringBuilder();
